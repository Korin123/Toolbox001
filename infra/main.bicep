...
param docIntelLocation string = 'uksouth'
...
param speechLocation string = 'uksouth'
...
param openAILocation string = 'uksouth'
...
param openAILLMModelVersion string = ''
...
@description('The OpenAI LLM model deployment SKU')
param openAIWhisperDeploymentSku string = 'GlobalStandard'
