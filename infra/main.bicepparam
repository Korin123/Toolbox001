...
param docIntelLocation = 'uksouth'

// Content Understanding
param deployContentUnderstandingMultiServicesResource = false
...
param contentUnderstandingLocation = 'uksouth'
